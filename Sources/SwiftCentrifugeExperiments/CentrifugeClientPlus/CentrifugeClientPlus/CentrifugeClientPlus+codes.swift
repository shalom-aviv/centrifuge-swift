...
public extension CentrifugeClientPlus {
    enum DisconnectedCode {
        static let disconnectCalled: UInt32 = 0 // analog in SwiftCentrifuge sources: let connectingCodeConnectCalled: UInt32 = 0
    }

    enum ConnectingCode {
        static let connectCalled: UInt32 = 0 //  analog in SwiftCentrifuge sources: let disconnectedCodeDisconnectCalled: UInt32 = 0
    }
}
